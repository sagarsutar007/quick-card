    ...
    <div class="card bg-light-info shadow-none position-relative overflow-hidden">
        <div class="card-body px-4 py-3">
            <div class="row align-items-center">
                <div class="col-9">
                    <h4 class="fw-semibold mb-8">Edit School</h4>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page">Edit School</li>
                        </ol>
                    </nav>
                </div>
                <div class="col-3">
            ...
            <form method="post" action="{{ route('schools.save', $school->id) }}">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="schoolCode" name="school_code" placeholder="Enter code here" value="{{ old('school_code', $school->school_code) }}">
                            <label for="schoolCode">School Code</label>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="schoolName" name="school_name" placeholder="Enter name here" value="{{ old('school_name', $school->school_name) }}">
                            <label for="schoolName">School Name</label>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="udiseNo" name="udise_no" placeholder="Enter udise no here" value="{{ old('udise_no', $school->udise_no) }}">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <select name="block_id" id="block_id" class="select2 form-control mb-3" style="width: 100%; height: 58px">
                            @foreach ($blocks as $block)
                                <option value="{{ $block->id }}" {{ old('block_id', $school->block_id) == $block->id ? 'selected' : '' }}>
                                    {{ $block->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <select name="cluster_id" id="cluster_id" class="select2 form-control mb-3" style="width: 100%; height: 58px">
                            @foreach ($clusters as $cluster)
                                <option value="{{ $cluster->id }}" {{ old('cluster_id', $school->cluster_id) == $cluster->id ? 'selected' : '' }}>
                                    {{ $cluster->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-6">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="schoolAddress" name="school_address" placeholder="Enter address here" value="{{ old('school_address', $school->school_address) }}">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <div class="form-floating mb-3 border rounded-2" style="border-color: #dfe5ef!important;">
                            ...
                            <div class="form-check form-check-inline ms-3 mb-2 mt-1">
                                <input class="form-check-input danger check-outline outline-danger" type="radio" id="active-radio" name="status" value="1" {{ old('status', $school->status) == 1 ? 'checked' : '' }}>
                                <label class="form-check-label" for="active-radio">Active</label>
                            </div>
                            <div class="form-check form-check-inline mb-2 mt-1">
                                <input class="form-check-input danger check-outline outline-danger" type="radio" id="in-active-radio" name="status" value="0" {{ old('status', $school->status) == 0 ? 'checked' : '' }}>
                ...
                <div class="row">
                    <div class="col-12 text-end">
                        <button type="submit" class="btn btn-primary font-medium waves-effect btn-loading">
                            Save & Next <i class="bi bi-arrow-right ms-2"></i>
                        </button>
                    </div>
                </div>
            </form>
